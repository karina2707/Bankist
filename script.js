...
// Functions
function formatMovDate(locale, date) {
...
function formatNumber(locale, currency, value) {
...
const startLogOutTimer = function () {
  const tick = function () {
    minutes = Math.trunc(timeInMSecs / 60);
    seconds = timeInMSecs % 60;
  ...
  let minutes = 1;
  let seconds = 10;
  let timeInMSecs = minutes * 60 + seconds;
